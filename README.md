...
```bash
mvn install:install-file -Dfile=target/ArnaconSDK-1.0.13.1.2.jar -DgroupId=com.Arnacon -DartifactId=ArnaconSDK -Dversion=1.0.13.1.2 -Dpackaging=jar
```

Ensure to replace target/ArnaconSDK-1.0.13.1.2.jar with the actual path to your generated JAR file.
