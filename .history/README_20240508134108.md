...
```bash
mvn install:install-file -Dfile=target/ArnaconSDK-1.0.4.6.jar -DgroupId=com.Arnacon -DartifactId=ArnaconSDK -Dversion=1.0.4.6 -Dpackaging=jar
```

Ensure to replace target/ArnaconSDK-1.0.4.6.jar with the actual path to your generated JAR file.
