...
```bash
mvn install:install-file -Dfile=target/ArnaconSDK-1.0.13.7.jar -DgroupId=com.Arnacon -DartifactId=ArnaconSDK -Dversion=1.0.13.7 -Dpackaging=jar
```

Ensure to replace target/ArnaconSDK-1.0.13.7jar with the actual path to your generated JAR file.
